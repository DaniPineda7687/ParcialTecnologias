...
public class BeverageRepository extends AbstractRepository<Product> {
    public BeverageRepository(Connection connection) {
        super(connection);
    }
    ...
    public List<Product> getAll() {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(query);
            ...
            while (resultSet.next()) {
                Product beverage = mapResultSet(resultSet);
    ...
    @Override
    public boolean update(int id, Product beverage) {
